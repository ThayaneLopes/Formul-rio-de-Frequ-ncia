...
<meta charset="utf-8">
  ...
  <link href="view/menu/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
			...
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Tables"><a class="nav-link" href="#"> <i
						class="fa fa-fw fa-file"></i> <span class="nav-link-text">Validar
							Formulários</span>
				</a></li>
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					href="#collapseMulti" data-parent="#exampleAccordion"> <i
						...
						class="nav-link-text">Buscas</span>
				</a>
