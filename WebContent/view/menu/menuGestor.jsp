...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="menuGestor.html">FormulÃ¡rio de FrequÃªncia</a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="#">
           ...
           <span class="nav-link-text">Cadastrar Orientador</span>
         </a>
       </li>
       ...
       <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
        ...
        <ul class="sidenav-second-level collapse" id="collapseExamplePages">
          <li>
            <a href="#">Alterar sua Conta</a>
          </li>
          <li>
            <a href="#">Alterar conta de Orientador</a>
          </li>
          <li>
            <a href="#">Alterar conta de Bolsista</a>
          </li>
        </ul>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Menu Levels">
         ...
         <ul class="sidenav-second-level collapse" id="collapseMulti">
          ...
          <li>
            <a href="#">Buscar por Orientador</a>
          </li>
